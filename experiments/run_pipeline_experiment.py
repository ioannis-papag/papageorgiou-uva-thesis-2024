...
def compute_accuracy(model, dataloader):
    ...
    return dataset_accuracy, validation_loss
...
def main():
    ...
    log_file = f'logs/{model_type}_{dataset_type}.log'
    ...
    for experiment in range(num_runs):
        ...
        for epoch in range(200):
            ...
            logging.info("-------------------------------------------------------------------------------------")
            torch.save(model.state_dict(), f'{model_type}_{dataset_type}_run_{experiment+1}')
